...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-o3p6ah");
    ...
    const file$3 = "src/components/Feedback.svelte";
    ...
    function create_default_slot(ctx) {
    	...
    	let t3;
    	let p;
    	let t4_value = /*item*/ ctx[0].comment + "";
    	let t4;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div, "class", "num-display svelte-1l7v4lw");
    			add_location(div, file$3, 10, 4, 260);
    			attr_dev(button, "class", "close svelte-1l7v4lw");
    			add_location(button, file$3, 13, 4, 323);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 14, 4, 399);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*item*/ 1 && t4_value !== (t4_value = /*item*/ ctx[0].comment + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    ...
    class Feedback extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*item*/ ctx[0] === undefined && !('item' in props)) {
    			console.warn("<Feedback> was created without expected prop 'item'");
    		}
    	}
    ...
    // (6:0) {#each feedbacks as fb (fb.id)}
    function create_each_block(key_1, ctx) {
    	...
    	feedback.$on("delete-feedback", /*delete_feedback_handler*/ ctx[1]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*feedbacks*/ 1) feedback_changes.item = /*fb*/ ctx[2];
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(6:0) {#each feedbacks as fb (fb.id)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let current;
    	let each_value = /*feedbacks*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$2, 4, 0, 98);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*feedbacks*/ 1) {
    				each_value = /*feedbacks*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let { feedbacks = [] } = $$props;
    	const writable_props = ['feedbacks'];
    	...
    	$$self.$$set = $$props => {
    		if ('feedbacks' in $$props) $$invalidate(0, feedbacks = $$props.feedbacks);
    	};

    	$$self.$capture_state = () => ({ Feedback, feedbacks });
    	...
    	return [feedbacks, delete_feedback_handler];
    }

    class FeedbackList extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { feedbacks: 0 });
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h10 = element("h1");
    			t0 = text("Number of reviews: ");
    			t1 = text(/*count*/ ctx[0]);
    			t2 = space();
    			h11 = element("h1");
    			t3 = text("Average rating: ");
    			t4 = text(/*average*/ ctx[1]);
    			add_location(h10, file$1, 5, 4, 78);
    			add_location(h11, file$1, 6, 4, 118);
    			add_location(main, file$1, 4, 0, 67);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	feedbacklist = new FeedbackList({
    			props: { feedbacks: /*feedbacks*/ ctx[0] },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 28, 0, 895);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*feedbacks*/ 1) feedbacklist_changes.feedbacks = /*feedbacks*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	let feedbacks = [
    		{
    			id: 1,
    			rating: 10,
    			comment: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Officia commodi hic quos tempora temporibus harum. Illum a nobis harum ullam."
    		},
    		{
    			id: 2,
    			rating: 9,
    		...
    		},
    		{
    			id: 3,
    			rating: 7,
    			comment: "Illum a nobis harum ullam. Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet."
    		}
    	];

    	const deleteFeedback = e => {
    		const itemId = e.detail;
    		$$invalidate(0, feedbacks = feedbacks.filter(item => item.id !== itemId));
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*feedbacks*/ 1) {
    			$$invalidate(2, count = feedbacks.length);
    		}

    		if ($$self.$$.dirty & /*feedbacks*/ 1) {
    			$$invalidate(1, average = feedbacks.reduce((a, { rating }) => a + rating, 0) / feedbacks.length);
    		}
    	};

    	return [feedbacks, average, count, deleteFeedback];
    }
